		...
		function onContextMenu(_event: any, params: any) {
			...
			menu.append(
				new MenuItem({
					...
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:red">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					...
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:blue">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					...
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:green">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					...
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:grey">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					...
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:white;background:red">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					label: _('Background:blue'),
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:white;background:blue">', '</span>', _(''));
					},
				})
			);
			menu.append(
				new MenuItem({
					label: _('Background:green'),
					enabled: true,
					click: async () => {
						wrapSelectionWithStrings('<span style="color:white;background:green">', '</span>', _(''));
					},
				})
			);
			menu.append(
